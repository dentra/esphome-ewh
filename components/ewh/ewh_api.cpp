...
void EWHApi::set_mode(ewh_mode_t::Mode mode, uint8_t target_temperature) {
...
void EWHApi::set_clock(uint8_t hours, uint8_t minutes) {
...
void EWHApi::set_timer(uint8_t hours, uint8_t minutes, uint8_t temperature, ewh_mode_t::Mode mode) {
...
void EWHApi::set_bst(bool value) {
...
void EWHApi::set_bst(const ewh_bst_t &bst) {
